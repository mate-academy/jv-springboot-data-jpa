...
public class ProductController {
    ...
    public List<ProductResponseDto> findByCategories(@RequestParam List<String> categories) {
    ...
    @GetMapping("/by-price")
    public List<ProductResponseDto> findBuPriceBetween(@RequestParam BigDecimal from,
