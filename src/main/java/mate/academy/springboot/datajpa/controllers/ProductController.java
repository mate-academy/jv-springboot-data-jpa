...
import mate.academy.springboot.datajpa.dto.responce.ProductResponseDto;
...
public class ProductController {
    ...
    @GetMapping("/by-price")
    public List<ProductResponseDto> getAllByPriceIsBetween(@RequestParam BigDecimal from,
