...
@Component
public class PhoneSpecificationManager implements SpecificationManager<Product> {
    private final Map<String, SpecificationProvider<Product>> providersMap;

    @Autowired
    public PhoneSpecificationManager(List<SpecificationProvider<Product>> phoneSpecification) {
        this.providersMap = phoneSpecification.stream()
