...
public class CategoryController {
    ...
    @PostMapping
    public CategoryResponseDto add(@RequestBody @Valid CategoryRequestDto dto) {
        return categoryMapper.mapToDto(categoryService.save(categoryMapper.mapToModel(dto)));
    }
